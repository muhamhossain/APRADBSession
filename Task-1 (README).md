...
Please refer to steps mentioned at https://github.com/muhamhossain/APRADBSession/blob/master/Infrastructure.md

## Infrastructure components
Once the Cloudformation Stack completes successfully would launch following components
  1. EC2 SQL Server Windows 2016 SQL Server 2016 SP2 ENT edition
  2. Aurora Postgres Cluster with single node.
  3. EC2 Client linux (amazon linux 2) which would be used to connect to source and targets database instances.
...
3. Aurora Postgres Writer and Reader Endpoints.
